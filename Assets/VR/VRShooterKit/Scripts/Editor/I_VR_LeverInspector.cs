...
namespace VRShooterKit.EditorCode
{
    ...
    public class I_VR_LeverInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorTools.PropertyField(transformBase);
            EditorTools.PropertyField(solverIterations);
            EditorTools.PropertyField(shouldBackToStartingPosition);
            EditorTools.PropertyField(backForce);
            ...
            EditorTools.PropertyField(onValueChange);
