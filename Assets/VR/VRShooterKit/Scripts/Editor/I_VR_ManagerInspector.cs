...
namespace VRShooterKit.EditorCode
{
    ...
    public class I_VR_ManagerInspector : Editor
    {
        ...
        private SerializedProperty leftController = null;
        private SerializedProperty rightController = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorTools.PropertyField( currentSDK );
            EditorTools.PropertyField( leftController );
            EditorTools.PropertyField( rightController );
