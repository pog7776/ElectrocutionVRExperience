    ...
    public class VR_CharacterController : MonoBehaviour , ISpeed
    {
        ...
        public virtual void UpdateMovement()
        {
            ...
            if (EnableLinearMovement)
            {
                ...
                moveInfluence *= 1.0f + (leftController.Input.GetButtonDown(VR_InputButton.Button_TumbstickPress) ? 1.0f : 0.0f);
#endif
               
                Vector2 primaryAxis = leftController.Input.GetJoystickInput();
            ...
            if (rightController.Input.GetButtonDown( VR_InputButton.Button_Primary ))
                Jump();
            ...
            if (EnableRotation)
            {
                ...
                if (SnapRotation)
                {
                    if (rightController.Input.GetButtonDown(VR_InputButton.Button_Thumbstick_Left))
                    {
                        if (ReadyToSnapTurn)
                        {
                    ...
                    else if (rightController.Input.GetButtonDown( VR_InputButton.Button_Thumbstick_Right ))
                    {
                        if (ReadyToSnapTurn)
                        {
                            euler.y += RotationRatchet;
                ...
                {
                    Vector2 secondaryAxis = rightController.Input.GetJoystickInput();                   
