...
namespace VRShooterKit
{
    public class VR_DistanceGrab : MonoBehaviour
    {
        ...
        [SerializeField] private VR_InputButton lineTriggerInput = VR_InputButton.Button_Trigger;        
        ...
        private bool HasSometingToGrab()
        {
        ...
        {
            return controller.CurrentGrab == null && ( guideLineAlwaysVisible || ( canTriggerLineRender && controller.Input.GetButtonDown( lineTriggerInput ) ) );
        }
        ...
        private void RenderLineToActiveGrabbable()
        {
            ...
            lineRender.SetPosition( 1, activeGrabbable.GetHandInteractionSettings( controller ).highlightPoint.position );
        }
